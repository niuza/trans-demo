...
//                    SocketAddress socketAddress = new InetSocketAddress(et.getText().toString(), 1991);
...
//                    if(!string.isEmpty()){
//                        socketChannel = SocketChannel.open();
//                        socketChannel.connect(new InetSocketAddress("192.168.191.2", 1991));
//                        sendData(socketChannel, string);
//                        System.out.println("接收到的文件路径:"+string);
//                        String filename = (string.split("/"))[(string.split("/").length-1)];
//                        System.out.println("获取到的文件名:"+filename);
//                        //设置显示的文件名
//                        label.setText(filename+" 接收中...");
//                        receiveFile(socketChannel, new File(STRINGS.getDburl()+filename));
//                        //设置完成提示
//                        label.setText("接收完成！单击完成退出~");
//                    }
//                } catch (Exception ex) {
